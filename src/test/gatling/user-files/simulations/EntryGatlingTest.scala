...
class EntryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Entry entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/entries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new entry")
            .post("/services/microservice/api/entries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "title":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_entry_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created entry")
            .delete("/services/microservice${new_entry_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
