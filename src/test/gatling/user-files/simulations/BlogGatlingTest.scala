...
class BlogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Blog entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/blogs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new blog")
            .post("/services/microservice/api/blogs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_blog_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created blog")
            .delete("/services/microservice${new_blog_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
